...
/// Channel from a teacher to a learner.
pub fn new_to_learner() -> Channel<NewData> { channel() }
...
pub trait Learner: Sync + Send {
  ...
  fn run(
    & self, LearnerCore, Arc<::instance::Instance>, ::common::data::NewData
  ) ;
